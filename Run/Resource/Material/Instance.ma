...
material =
{
	vsVersion = "vs_5_0",
	psVersion = "ps_5_0",
	vs = "Resource/Shader/instance.vs",
	ps = "Resource/Shader/instance.ps",
	vsMain = "vsMain",
	psMain = "psMain",
	texture0 = "Resource/Texture/stone01.dds",
	...
	elementItem = 
	{
		...
		[3] = 
		{
			...
			Format = 6,							--DXGI_FORMAT_R32G32B32_FLOAT
			InputSlot = 1,
			AlignedByteOffset = 0,				--D3D11_APPEND_ALIGNED_ELEMENT,
