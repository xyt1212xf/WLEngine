...
material =
{
	vsVersion = "vs_5_0",
	psVersion = "ps_5_0",
	vs = "Resource/Shader/light.vs",
	ps = "Resource/Shader/light.ps",
	vsMain = "LightVertexShader",
	psMain = "LightPixelShader",
	texture0 = "Resource/Texture/marble01.dds",
	
	ZDepth = 1,
	CullMode = 4,        --D3D11_CULL_NONE	= 1, D3D11_CULL_FRONT	= 2, D3D11_CULL_BACK	= 3
	Transparent = 0,
	Shadow = 0,
	vsConstBuffer = 
	{
