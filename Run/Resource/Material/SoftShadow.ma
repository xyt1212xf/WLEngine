...
material =
{
	...
	{	
		...
		{		
			...
			vs = "Resource/Shader/DrawShadow.vs",
			ps = "Resource/Shader/DrawShadow.ps",
			vsMain = "vsMain",
			psMain = "psMain",
		...
		{		
			...
			vs = "Resource/Shader/DrawScreen.vs",
			ps = "Resource/Shader/DrawScreen.ps",
			vsMain = "vsMain",
			psMain = "psMain",
		},
		...
		{		
			...
			vs = "Resource/Shader/horizontalblur.vs",
			ps = "Resource/Shader/horizontalblur.ps",
			vsMain = "vsMain",
			psMain = "psMain",
		...
		{		
			...
			vs = "Resource/Shader/verticalblur.vs",
			ps = "Resource/Shader/verticalblur.ps",
			vsMain = "vsMain",
			psMain = "psMain",
		...
		{		
			...
			vs = "Resource/Shader/SoftShadow.vs",
			ps = "Resource/Shader/SoftShadow.ps",
			vsMain = "vsMain",
			psMain = "psMain",
