...
material =
{
	...
	{	
		[1] = 
		{
			...
			vs = "Resource/Shader/transparentdepth.vs",
			ps = "Resource/Shader/transparentdepth.ps",
			vsMain = "vsMain",
			psMain = "psMain",			
		},
		[2] = 
		{		
			...
			vs = "Resource/Shader/ShadowMap.vs",
			ps = "Resource/Shader/ShadowMap.ps",
			vsMain = "vsMain",
			psMain = "psMain",
	...
	ZDepth = 1,
	CullMode = 6,        --D3D11_CULL_NONE	= 1, D3D11_CULL_FRONT	= 2, D3D11_CULL_BACK	= 3
	Transparent = 1,
